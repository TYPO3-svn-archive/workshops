 ...
 *
 * $Id: example_amenuUserFunc.php,v 0.0.1 2005/01/17 09:44:30 spadberg Exp $
 *
...
/*  add this to your TS setup:
		...
		# call user function
		plugin.workshops.workshopsAmenuUserFunc = user_processAmenu
...
function user_processAmenu($amenuItemsArr, $conf){
	...
	// $tmpl = '<div class="workshops-archive-item">###ARCHIVE_YEAR###</div>';
