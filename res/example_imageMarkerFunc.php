...
***************************************************************/
/**
 * This is an example for processing the workshop item images by a user function.
 *
...
/*  add this to your TS-setup:
    ...
    includeLibs.imageMarkerFunc = EXT:workshops/res/example_imageMarkerFunc.php

	plugin.workshops {
 		# call user function
 		imageMarkerFunc = user_imageMarkerFunc
 		displaySingle {
 			imageWrapIfAny_0 = <div class="workshops-single-images-container0"> | </div>
    		        imageWrapIfAny_1 = <div class="workshops-single-images-container1"> | </div>
    		        imageWrapIfAny_2 = <div class="workshops-single-images-container2"> | </div>
    		        imageWrapIfAny_3 = <div class="workshops-single-images-container3"> | </div>
		}
		# example styles for the new wraps
		_CSS_DEFAULT_STYLE (
		  	.workshops-single-images-container0, .workshops-single-images-container1, .workshops-single-images-container2, .workshops-single-images-container3 { width: 200px; margin-left: 5px; }
			.workshops-single-images-container0 { background-color: #900; }
			.workshops-single-images-container1 { background-color: #090; }
			.workshops-single-images-container2 { background-color: #009; }
			.workshops-single-images-container3 { background-color: #990; }
		)
 	}
